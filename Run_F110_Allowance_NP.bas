Attribute VB_Name = "Run_F110_Allowance_NP"
Public BDPass As String
Public BDUserName As String

Sub Run_F110_Allowance_NP()

'Same as F110_Allowance just different tab name
...
ActivateWindow (Application.hwnd)    'Brings the Excel window to the front
                ...
                wb.Sheets.Add(After:=Sheets("Macro Input")).Name = "F110_NP_" & wb.Sheets.Count
                
                Dim screenshot_sheet As Worksheet
                Set screenshot_sheet = wb.Sheets("F110_NP_" & wb.Sheets.Count - 1)
...
'Add proposal for CB0P EFT allowance roll payments
 ...
 Range("N1").Select
    ...
    ActiveWorkbook.Names.Add Name:="CB_NP_F110_CB0P", RefersToR1C1:= _
        "=" & screenshot_sheet.Name & "!R1C14"
    
    Range("N35").Select
    ActiveWorkbook.Names.Add Name:="CB_NP_F110_CB0T", RefersToR1C1:= _
        "=" & screenshot_sheet.Name & "!R35C14"
