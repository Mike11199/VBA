Attribute VB_Name = "Run_F110_Allowance_Manual"
Public BDPass As String
Public BDUserName As String

Sub Run_F110_Allowance_Manual()
...
'Add proposal for CB0M manual allowance roll payments
                ...
                SAP_Session.FindById("wnd[0]/usr/ctxtF110V-LAUFI").Text = "CB0M"
                ...
                'change to S for manual or else proposal won't grab payments
                SAP_Session.FindById("wnd[0]/usr/tabsF110_TABSTRIP/tabpPAR/ssubSUBSCREEN_BODY:SAPF110V:0202/tblSAPF110VCTRL_FKTTAB/ctxtF110V-ZWELS[1,0]").Text = "S"
                ...
                FTB_WH = ThisWorkbook.Sheets("Template").Range("TOTAL_STATE_WH")
                 ...
                 'IRS
                answer = MsgBox("Add IRS Vendor GL for this Payment Proposal?" & vbNewLine & vbNewLine & "Fed WH Amount:  " & IRS_WH, vbQuestion + vbYesNo + vbDefaultButton2, "Add IRS Vendor?")
                ...
                'FTB
                answer2 = MsgBox("Add FTB Vendor GL for this Payment Proposal?" & vbNewLine & vbNewLine & "State WH Amount:  " & FTB_WH, vbQuestion + vbYesNo + vbDefaultButton2, "Add FTB Vendor?")
...
ActivateWindow (Application.hwnd)    'Brings the Excel window to the front
                ...
                wb.Sheets.Add(After:=Sheets("Macro Input")).Name = "F110_Manual_" & wb.Sheets.Count
                
                Dim screenshot_sheet As Worksheet
                Set screenshot_sheet = wb.Sheets("F110_Manual_" & wb.Sheets.Count - 1)
 ...
 Call Add_Check_Formulas_to_WOs_2
...
Sub Add_Check_Formulas_to_WOs_2()
...
'
    ...
    ActiveCell.FormulaR1C1 = "=R[-11]C-R[-1]C"
