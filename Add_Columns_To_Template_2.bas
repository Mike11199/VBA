Attribute VB_Name = "Add_Columns_To_Template_2"
Sub Add_Columns_To_Import_Template_2()
...
'=========Change both Named_Range_2 to other number or toother named range to map other tables to a template============
  If BET_RangeNameExists(Named_Range_2) = True Then
        Application.GoTo Reference:=Named_Range_2
        MapperRange = ThisWorkbook.ActiveSheet.Range(Named_Range_2)
Else
        MsgBox ("ERROR: The cell Named_Range_2 is empty on the 'Macro Input' tab, or the named range referenced there is misspelled or does not exist in this workbook." & vbNewLine & vbNewLine & "Please click OK to end the macro.")
        End
End If
'=====================================================================================================================
