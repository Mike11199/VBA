Attribute VB_Name = "ZAPCLAIM_SP01_Allowance"
Public BDPass As String
Public BDUserName As String

Sub Run_ZAPCLAIM_SPO1_Allowance()
...
'Generate claim and print claim schedule for paper allowance roll payments
                ...
                wb.Sheets("Macro Input").Range("CS_1") = Paper_Claim_Number
                ...
                If Printed = "Printed succesfully" Then
                        wb.Sheets("Macro Input").Range("CS_1_PRINT") = "X"
                End If
 ...
 'Generate claim and print claim schedule for EFT allowance roll payments
                ...
                wb.Sheets("Macro Input").Range("CS_2") = EFT_Claim_Number
                SAP_Session.FindById("wnd[0]/tbar[0]/btn[15]").press
                ...
                If Printed = "Printed succesfully" Then
                        wb.Sheets("Macro Input").Range("CS_2_PRINT") = "X"
                End If
...
"The macro has finished running ZAPCLAIM for CB Allowance Roll." & vbNewLine & vbNewLine & _
"Please press OK."
